Feature: Connexion
    ...
    Scenario: Se connecter sur sauce demo
    ...
    # Scenario: Se connecter sur sauce demo avec des variables d'environnement
    #     When Connexion à sauce demo en utilisant les variables d'environnement